...
# ── Core bot config ────────────────────────────────────────────────────────────
API_ID = int(getenv("API_ID", 37872912))
API_HASH = getenv("API_HASH", "5cbd343f4c61a20921d80235ae4cd347")
BOT_TOKEN = getenv("BOT_TOKEN")

OWNER_ID = int(getenv("OWNER_ID", 8620006563))
OWNER_USERNAME = getenv("OWNER_USERNAME", "@Darkownerr")
BOT_USERNAME = getenv("BOT_USERNAME", "@Darkkkkkkaurabot")
BOT_NAME = getenv("BOT_NAME", "ꜱʜᴀᴅᴏᴡ ᴍᴜꜱɪᴄ ʙᴏᴛ")
ASSUSERNAME = getenv("ASSUSERNAME", "Darkkkkkkaurabot")

# ── Database & logging ─────────────────────────────────────────────────────────
MONGO_DB_URI = getenv("MONGO_DB_URI")
LOGGER_ID = int(getenv("LOGGER_ID", -1003975422732))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://t.me/Darkownerr")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN")  # needed if repo is private

# ── Support links ──────────────────────────────────────────────────────────────
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/fuckerbihari00")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/fuckerbihario")
...
START_IMG_URL = "https://files.catbox.moe/3rry7j.jpg"
